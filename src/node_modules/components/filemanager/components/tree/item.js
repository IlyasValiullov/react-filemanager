...
import './item.css';
import {getDirs} from "components/filemanager/store/tree/reducer";
    ...
    renderItems = () => {
        ...
        if (this.props.model.hasOwnProperty('children')){
            return this.props.model.children.map((item, index) => (
                <Item className="item" key={item.id} selectedFile={this.props.selectedFile} openFile={this.props.openFile} selectFile={this.props.selectFile} model={item}/>
            ));
        }
    };
        ...
        return (
            <li className="first_child_margin">
                <div className="wrapper">
                    ...
                    <span className={classnames("item-text", "noselect", {item_text_active: this.props.selectedFile == this.props.model.path })}
                        onDoubleClick={this.doubleClick} onClick={this.toggle}>{model.name}</span>
                </div>
                <ul className="item" >
                    { this.renderItems() }
                </ul>
