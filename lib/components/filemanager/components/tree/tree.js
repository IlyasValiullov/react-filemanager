...
var _actionTypes = require('../../store/tree/actionTypes');

var treeTypes = _interopRequireWildcard(_actionTypes);
...
var Tree = function (_Component) {
    ...
    function Tree(props) {
        ...
        _this.cleanSelect = function () {
            _this.props.dispatch({ type: treeTypes.CLEAN_SELECT });
        };

        _this.renderItems = function () {
            return _this.props.dirs.map(function (item, index) {
                return _react2.default.createElement(_.Item, { className: 'item', key: item.id, selectedFile: _this.props.selectedFile, openFile: _this.openNode, selectFile: _this.selectFile, model: item });
            });
        };
