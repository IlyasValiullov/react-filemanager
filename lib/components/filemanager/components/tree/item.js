...
var _reducer = require('components/filemanager/store/tree/reducer');
...
// import { getSelectedFile } from "../../store/tree/reducer";
...
var Item = function (_Component) {
        ...
        _this.renderItems = function () {
            ...
            if (_this.props.model.hasOwnProperty('children')) {
                return _this.props.model.children.map(function (item, index) {
                    return _react2.default.createElement(Item, { className: 'item', key: item.id, selectedFile: _this.props.selectedFile, openFile: _this.props.openFile, selectFile: _this.props.selectFile, model: item });
                });
            }
        };
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            console.log("selected", this.props.selectedFile);
            console.log("model", this.props.model.path);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: (0, _classnames2.default)("item-text", "noselect", { item_text_active: this.props.selectedFile == this.props.model.path }),
                            onDoubleClick: this.doubleClick, onClick: this.toggle },
                        model.name
                    )
                ),
                _react2.default.createElement(
