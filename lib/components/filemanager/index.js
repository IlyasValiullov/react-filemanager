...
var FileManager = function (_React$Component) {
    ...
    function FileManager(props, context) {
        ...
        _this.setShowFileManager = function () {
            _this.setState({
        ...
        _this.renderFileManager = function () {
            if (_this.state.showFileManager) {
                return _react2.default.createElement(
                    _reactRedux.Provider,
                    { store: store },
                    _react2.default.createElement(_components.FileManagerCore, { selectFile: _this.selectFile, auth_url: _this.props.auth_url })
                );
            }
            return null;
        };
