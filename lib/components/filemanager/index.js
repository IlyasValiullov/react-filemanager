...
var FileManager = function (_React$Component) {
    ...
    function FileManager(props, context) {
        ...
        return _possibleConstructorReturn(this, (FileManager.__proto__ || Object.getPrototypeOf(FileManager)).call(this, props, context));
    }
    ...
    _createClass(FileManager, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                { store: store },
                _react2.default.createElement(_components.FileManagerCore, { closeFileManager: this.closeFileManager, auth_url: this.props.auth_url })
            );
        }
    }]);
